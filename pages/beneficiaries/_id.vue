  ...
  <div class="main">
    ...
    <div class="row no-gutters pt-lg-4">
      <div class="col-lg-8">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="card__holder px-3 pt-2">
              ...
              <h4 class="funds pb-2">N125,000</h4>
            </div>
          </div>
        ...
        <!-- Campaigns here -->
        <div class="mt-5 pt-2">
          <h4 class="top-header">Campaigns</h4>
        ...
        <div class="div__holder p-3">
          ...
          <div class="d-table" style="border-spacing: 0px 20px;">
            ...
            <div class="d-table-row row">
              ...
              <p class="detail-value col">{{ BENEFACTOR.name }}</p>
            </div>

            <!-- user id here -->
            <div class="d-table-row row">
              <p class="detail-caption col">User ID</p>
              <p class="detail-value col">{{ BENEFACTOR.id }}</p>
            </div>

            <!-- Phone number here -->
            <div class="d-table-row row">
              <p class="detail-caption col">Phone Number</p>
              <p class="detail-value col">+{{ BENEFACTOR.number }}</p>
            </div>

            <!-- Email here -->
            <div class="d-table-row row">
              <p class="detail-caption col">Email Address</p>
              <p class="detail-value col">{{ BENEFACTOR.email }}</p>
            </div>

            <!-- Date created here -->
            <div class="d-table-row row">
              <p class="detail-caption col">Created</p>
              <p class="detail-value col">{{ BENEFACTOR.created }}</p>
            </div>
          </div>
        </div>
      </div>
